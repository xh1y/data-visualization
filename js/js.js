...
// Resize event for setting the font size
...
// Functions to handle echarts and other custom charts
window.addEventListener('load', function () {
  echarts_1();
  echarts_2();
  echarts_3();
...
// Example for converting echarts initialization (echarts_1) from jQuery to vanilla JS
function echarts_1() {
